...
if __name__ == "__main__":
    ...
    for epoch in range(100):
        ...
        for i in range(len(X_t)):
            ...
            # grad_theta_tau_i = tau.net[0].weight.grad.data[0].clone()
            # grad_theta_tau_xt.append(grad_theta_tau_i)
            ...
            # grad_theta_tau_i = tau.net[0].weight.grad.data[0].clone()
            # grad_theta_tau_xtp1.append(grad_theta_tau_i)
        ...
        for param in tau.named_parameters():
            ...
            grad_J_tau = (tiled_tau_xt * grad_theta_tau_xt_MAT).mean(0) - (1 - alpha_t) * (tiled_tau_xt * grad_theta_tau_xt_MAT).mean(0) - alpha_t * (tiled_tau_xtp1 * grad_theta_tau_xtp1_MAT).mean(0) + 2*lam*v*grad_theta_tau_xt_MAT.mean(0)
